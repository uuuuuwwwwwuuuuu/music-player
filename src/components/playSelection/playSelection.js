...
export default class PlaySelection extends Component {
    ...
    render() {
        const {data, id, isPlay, isRepeat, isRandom, showPlayList} = this.state;
        let leftElements = null;
        let url = null;
        if (data) {
            leftElements = this.renderTrackInfo();
            url = data.filter(item => item.id === id)[0].music;
        }
            ...
            <div className="play_selection">
                ...
                <div className="right_elements">
                    <div className="music_controllers">
                        <button onClick={this.toggleIsRandom}>
                        ...
                        <button onClick={this.changeIsPlay} className={disablePlayClass}>                            
                        ...
                        <button className={disablePauseClass}>                                        
                        ...
                        <button onClick={this.toggleIsRepeat}>
