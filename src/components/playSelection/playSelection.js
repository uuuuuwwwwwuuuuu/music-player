...
import albumImg from './img/e78f05f9417faa5fc339c374810fa35e.1000x1000x1.jpg';
            ...
            <div className="play_selection">
                <div className="left_elements">
                    ...
                    <div className="left_elements_info">
                        <span className="left_elements_title">Больше не буду</span>
                        <span className="left_elements_artists">Тринадцать карат, Три дня дождя</span>
                    </div>
                </div>
